...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" media="screen" href="{{ asset ('shopTemplate/css/vendor.min.css') }}">
    <!-- Main Template Styles-->
    <link id="mainStyles" rel="stylesheet" media="screen" href="{{ asset('shopTemplate/css/styles.min.css') }}">
    <!-- Customizer Styles-->
    <link rel="stylesheet" media="screen" href="{{ asset ('shopTemplate/customizer/customizer.min.css') }}">
    <!-- Modernizr-->
    <script src="{{ asset('shopTemplate/js/modernizr.min.js') }}"></script>
  </head>
  <!-- Body-->
  <body>
    ...
    <div class="topbar">
      ...
      <div class="topbar-column"><a class="hidden-md-down" href="#"><i class="icon-download"></i>&nbsp; Get mobile app</a>
        <div class="lang-currency-switcher-wrap">
          <div class="lang-currency-switcher dropdown-toggle"><span class="language"><img alt="English" src="{{ asset('shopTemplate/img/flags/GB.png') }}"></span><span class="currency">$ USD</span></div>
          <div class="dropdown-menu">
            <div class="currency-select">
              <select class="form-control form-control-rounded form-control-sm">
                ...
                <img src="{{ asset('shopTemplate/img/flags/FR.png') }}" alt="Français">Français</a>

                <a class="dropdown-item" href="#">
                <img src="{{ asset('shopTemplate/img/flags/DE.png') }}" alt="Deutsch">Deutsch</a>
                
                <a class="dropdown-item" href="#">
                <img src="{{ asset('shopTemplate/img/flags/IT.png') }}" alt="Italiano">Italiano</a>
          </div>
        </div>
      </div>
    </div>
        ...
        <div class="container">
          ...
          <div class="row">
            <div class="col-md-7 padding-bottom-1x">
              <!-- Payment Methods-->
              <div class="margin-bottom-1x" style="max-width: 615px;"><img src="{{ asset('shopTemplate/img/payment_methods.png') }}" alt="Payment Methods">
              </div>
            </div>
    ...
    <script src="{{ asset('shopTemplate/js/vendor.min.js') }}"></script>
    <script src="{{ asset('shopTemplate/js/scripts.min.js') }}"></script>
    <!-- Customizer scripts-->
    <script src="{{ asset('shopTemplate/customizer/customizer.min.js') }}"></script>
  </body>
</html>